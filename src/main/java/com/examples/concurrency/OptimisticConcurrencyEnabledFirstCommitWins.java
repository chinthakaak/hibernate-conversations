 ...
 */
public class OptimisticConcurrencyEnabledFirstCommitWins {


    public static class OptimisticConcurrencyEnabledFirstCommitWinsVersionTest {
        @Test
        public void testOptimisticConcurrencyEnabledFirstCommitWinsVersionTest() throws InterruptedException {
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        Assert.assertTrue(e.getMessage().contains("Row was updated or deleted by another transaction"));
                    }
                    session.close();
                }
            }.start();
            ...
            Assert.assertEquals("First Commit", user1.getName());
            tx2.commit();
            session2.close();
        }
